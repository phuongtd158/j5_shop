			...
			<div class="row mt-2 mb-4">
				...
				<div class="col-5 justify-content-end">
					<div class="row align-items-center">
						...
						<div class="col-4">
							<%-- <i class='bx bx-box fs-5'></i> Tổng danh mục <span
						...
						<c:forEach items="${listCategories}" var="category"
							...
							<tr class="align-middle">
								...
								<td><a class="btn btn-warning"
									href="${pageContext.request.contextPath}/admin/category/edit/${category.id}">Sửa</a>
									...
									<div class="modal fade" id="exampleModal${category.id}"
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">Bạn có muốn xóa danh mục
													${category.name} không ?</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-secondary"
														data-bs-dismiss="modal">Close</button>
													<a type="button" id="btnDelete" class="btn btn-primary"
														href="${pageContext.request.contextPath}/admin/category/delete/${category.id}">Xóa</a>
												</div>
											</div>
										</div>
									</div></td>
